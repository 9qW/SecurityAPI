...
client.on('guildCreate', (guild) => {
    ...
    .addField('Reaction Interpretation | URl Scanner', [
...
client.on('message', async message => {
    if(message.author.bot) return;
if(message.content === "s!scan") {
    const embed = new MessageEmbed()
        .setTitle("Scan Interpretation")
        .addField('How is this working?', [
         `
        ...
        .addField('Reaction Interpretation', [
           `🔍: The URL is being scanned.`,
           `🟥: The URL is a malware/virus/iplogger/scam/phishing URL.`,
           `🟨: The URL is unsecure (http) or is a URL Shrink.`,
           `If there is no longer any visible reaction, it means that the URL is not a threat.`,
...
if(message.content === "s!help") {
    ...
    .addField('**General**', [
        `❯ s!help | For help`, 
        `❯ s!scan | Interpretation aid for the scan results.`,
